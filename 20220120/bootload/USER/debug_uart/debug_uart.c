...
void DEBUG_UART_IRQHandler(void)
{
	...
	while(  RESET==USART_GetFlagStatus(AIR724_4G_UART,USART_FLAG_TXE) );//等待发送缓冲区空
	USART_SendData(AIR724_4G_UART,  data );   
...
****************************************************************************************
*/
void debug_uart_tx_bytes( uint8_t* TxBuffer, uint8_t Length )
{
	while( Length-- )
	{
