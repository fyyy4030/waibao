...
//获取CRC16校验值(CRC16-MODBUS  0x8005 (0xFFFF))
// puchMsg:要校验的数组
// usDataLen:校验的长度
//返回值:CRC16码
...
//void crc_test(void)
//{
//	 uint32_t   time1 = xTaskGetTickCount();
//	 crc_value=calc_crc32(0x00000000,(uint32_t*)0x8000000, 1024*(512));
//     t2=xTaskGetTickCount()-time1;
//}
